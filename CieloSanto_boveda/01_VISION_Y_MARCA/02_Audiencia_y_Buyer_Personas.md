---
title: Audiencia Objetivo y Buyer Personas
...
```mermaid
quadrantChart
    title Matriz de Necesidades Espirituales de la Comunidad
    x-axis "Baja Frecuencia" --> "Alta Frecuencia (Diaria)"
    y-axis "Introspectivo / Personal" --> "Comunitario / Social"
    quadrant-1 "Intercesión Colectiva (Muro de Oración)"
    quadrant-2 "Campañas Solidarias (Pan y Abrigo)"
    quadrant-3 "Lectura de Emergencia en Crisis"
    quadrant-4 "Devocional Matutino (Salmo del Día)"
    "Lectura de Salmo 23": [0.85, 0.35]
    "Muro de Peticiones": [0.75, 0.85]
    "Ofrenda Mensual": [0.25, 0.75]
    "Oraciones del Alba 7:00 AM": [0.90, 0.40]
```
